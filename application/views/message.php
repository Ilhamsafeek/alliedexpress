...
<head>
    ...
    <title>Messages-Connecting-Hearts</title>
...
<body>
        ...
        <div class="row h-100">
            <div class="col-12 col-sm-5 col-md-4 d-flex flex-column" id="chat-list-area" style="position:relative;">
                ...
                <div class="row d-flex flex-row align-items-center p-2" id="navbar">
                    <img src="<?php echo base_url('assets/images/photos-profile.png '); ?>" alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:50px; cursor:pointer;" id="display-pic">
                    <div class="text-white font-weight-bold" id="username"><?php echo $this->session->userdata('username'); ?></div>
                ...
                <div class="row" id="chat-list" style="overflow:auto;">
                     ...
                     <?php foreach ($topic_data as $key => $value) { ?>
                        <div class="chat-list-item d-flex flex-row w-100 p-2 border-bottom unread" onclick="generateMessageArea(this, 0)">
                        <img src="<?php echo base_url('assets/images/user-profile.png '); ?>" alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:40px;">
                        <div class="w-50">
                            <div class="name"><?php echo $value['topic']; ?></div>
                            <div class="small last-message"><?php echo $value['from_user']; ?>: yeah, i'm online</div>
                        </div>
            ...
            <div class="d-none d-sm-flex flex-column col-12 col-sm-7 col-md-8 p-0 h-100" id="message-area">
                ...
                <div class="row d-flex flex-row align-items-center p-2 m-0 w-100" id="navbar">
                    ...
                    <a href="#"><img src="<?php echo base_url('assets/images/photos-profile.png '); ?>" alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:50px;" id="pic"></a>
    ...
    <script>
		...
		<div class="chat-list-item d-flex flex-row w-100 p-2 border-bottom ${unreadClass}" onclick="generateMessageArea(this, ${index})">
			<img src="<?php echo base_url('assets/images/photos-profile.png '); ?>" alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:50px;">
			<div class="w-50">
